<template>
  <div class="ordering">
    ...
    <el-card>
      ...
      <!-- 分页区域 -->
      <el-pagination v-model:currentPage="queryInfo.pageNo" v-model:page-size="queryInfo.pageSize"
    ...
    <el-dialog v-model="dialogFormVisible" title="编辑" width="50%" draggable @close="editDialogClose">
      <el-form ref="editFormRef" :model="editForm" :rules="editFormRules" label-width="120px" label-position="top">

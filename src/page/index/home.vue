...
export default {
    data() {
        return {
            ...
            cardList: [
                {title: '草薙京',img: require("@/assets/img/333.jpg")},
                {title: '雅典娜',img: require("@/assets/img/111.jpg")},
                {title: '拉尔夫',img: require("@/assets/img/222.jpg")},
                {title: '金家潘',img: require("@/assets/img/444.jpg")}
            ]
        }
    },
    methods:{

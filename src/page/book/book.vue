<template>
    <div>
        ...
        <el-card style="margin-top: 30px;">
            <el-row :gutter="40">
                <el-col :span="6">
                    <el-input placeholder="请输入内容" v-model="pageInfo.query" clearable @input="getBookList"
                        @clear="getBookList">
                        <template #append>
        ...
        <el-dialog v-model="createDialogFormVisible" title="资料上传" width="60%" draggable @close="createDialogClose">
            <el-form ref="createFormRef" :model="createForm" :rules="createFormRules" label-width="10px"
                ...
                <el-upload class="upload-demo" ref="upload" action="doUpload" drag multiple :limit="1"
            ...
            confirmCreate2() {
                ...
                this.$http.post("/research/create", this.createForm)
                    .then((res) => {
                        ...
                        fileFormData.append('file', this.file, this.file
                        .name); //filename是键，file是值，就是要传的文件，test.zip是要传的文件名
                        let requestConfig = {
                            headers: {
